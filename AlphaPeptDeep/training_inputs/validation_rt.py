...
model_mgr_rt.load_external_models(rt_model_file = "./saved_models/arg_inrich_tandem/rt_563524/rt.pth")
output_training_rt_transfer=model_mgr_rt.predict_rt(precursor_df)
output_training_rt_transfer.to_csv("./arg_inrich_tandem/output/validation_rt_output.tsv",sep="\t")