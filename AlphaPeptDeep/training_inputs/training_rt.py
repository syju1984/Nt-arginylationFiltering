...
import pandas as pd
precursor_df = pd.read_table('./arg_inrich_tandem/input/input_rt_training_new.tsv')
#fragment_intensity_df = pd.read_table('./arg_inrich_tandem/input/ms2_training_frag_df.tsv')
...
model_mgr_rt.load_installed_models('generic')
...
output_training_rt_transfer.to_csv("./arg_inrich_tandem/output/training_rt_output.tsv",sep="\t")
model_mgr_rt.save_models("./saved_models/arg_inrich_tandem/rt_563524/") ##current best!