...
import pandas as pd
precursor_df = pd.read_table('./arg_inrich_tandem/input/validation.tsv')
fragment_intensity_df = pd.read_table('./arg_inrich_tandem/input/validation_frag_df.tsv')
...
model_mgr.load_external_models(ms2_model_file = "./saved_models/arg_inrich_tandem/ms_311547/ms2.pth")
